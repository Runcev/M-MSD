...
const App = () => {
    const [fileData, setFileData] = useState<string | ArrayBuffer | null | undefined>('');
        ...
        <div className="App">
            ...
            {fileData && (
                <div className="answers">
                    <p id="1">Чотирикунтник {String(quadrangle)} </p>
                    <p id="2">Опуклий {String(convex)}</p>
                    <p id="3">Неопуклий {String(!convex)}</p>
                </div>
            )}
            <div id="calculator"/>
        </div>
